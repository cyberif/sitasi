                ...
                <div class="col-12">
                    <div class="card top-selling overflow-auto">
                        <div class="card-body pb-0">
                            ...
                            <form class="row g-3" method="POST" action="<?= base_url('admin/tambahSiswa'); ?>">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <input type="number" class="form-control" id="floatingName" placeholder="NIS" name="nis">
                                            <label for="floatingName">NIS</label>
                                        </div>
                                    </div>
                                    <?= form_error('nis', '<small class="text-danger ps-3">', '</small>'); ?>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div class="form-floating">
